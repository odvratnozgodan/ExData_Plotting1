...
# Plot 1
plot(xrange, dateRange$Global_active_power, type="l", xlab="", ylab="Global Active Power", axes = FALSE)
axis(1, at=0:2, lab=c("Thu","Fri","Sat"))
axis(2, las=1, at=2*0:8)
box()

# Plot 2
plot(xrange, dateRange$Voltage, type="l", xlab="datetime", ylab="Voltage", axes = FALSE)
axis(1, at=0:2, lab=c("Thu","Fri","Sat"))
axis(2, las=1, at=seq(234, 246, by=2), lab=c("234", "", "238", "", "242", "", "246"))
box()
...
# Plot 4
plot(xrange, dateRange$Global_reactive_power, type="l", xlab="", ylab="Global_reactive_power", axes = FALSE)
axis(1, at=0:2, lab=c("Thu","Fri","Sat"))
